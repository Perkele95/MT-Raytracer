...
template<typename T>
constexpr inline vec2<T> VECTOR_API operator*(T value, vec2<T> a)
{
    return a * value;
}
...
template<typename T>
constexpr inline vec2<T> VECTOR_API hadamard(vec2<T> a, vec2<T> b)
{
    return vec2(a.x * b.x, a.y * b.y);
}
...
template<typename T>
constexpr inline vec3<T> VECTOR_API operator*(T value, vec3<T> a)
{
    return a * value;
}
...
template<typename T>
constexpr inline vec3<T> VECTOR_API hadamard(vec3<T> a, vec3<T> b)
{
    return vec3(a.x * b.x, a.y * b.y, a.z * b.z);
}
...
template<typename T>
constexpr inline vec4<T> VECTOR_API operator*(T value, vec4<T> a)
{
    return a * value;
}
...
template<typename T>
constexpr inline vec4<T> VECTOR_API hadamard(vec4<T> a, vec4<T> b)
{
    return vec4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
}
